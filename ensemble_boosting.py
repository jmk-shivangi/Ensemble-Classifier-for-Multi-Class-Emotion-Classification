...
cols = ['text','emotion']
tweets_df = pd.read_csv('l1sorted.csv',header=None,names=cols)
...
model2 = LinearSVC(C=1.0, intercept_scaling=1, multi_class='ovr', class_weight='balanced', random_state=0, tol=0.0001, verbose=0)
model3 = LogisticRegression(class_weight='balanced',multi_class='ovr')
#bgt_svm = BaggingClassifier(LinearSVC(C=1.0, intercept_scaling=1, multi_class='ovr', class_weight='balanced', random_state=0, tol=0.0001, verbose=0))
for train_index, test_index in skf:
	...
	ensemble = AdaBoostClassifier(base_estimator=model4, n_estimators=50, learning_rate=1.0, algorithm='SAMME', random_state=None)
	ensemble.fit(X_train_tfidf, y_train)
	ens_predictions = ensemble.predict(X_test_tfidf)
